                        ...
                        return interaction.editReply({
                            embeds: [
                                new EmbedBuilder()
                                    ...
                                    .addFields(
                                        { name: "Mi eleccion", value: "Piedra", inline: true },
                        ...
                        return interaction.editReply({
                            embeds: [
                                new EmbedBuilder()
                                    ...
                                    .setDescription(`\`\`\`Empate\`\`\``)
                                    .addFields(
                                        { name: "Mi eleccion", value: "papel", inline: true },
                                        { name: "Eleccion del bot", value: "papel", inline: true }
                                    )
                            ],
                            components: []
                        ...
                        return interaction.editReply({
                            embeds: [
                                new EmbedBuilder()
                                    ...
                                    .setDescription(`\`\`\`Has perdido la partida el bot gana\`\`\``)
                                    .addFields(
                                        { name: "Mi eleccion", value: "Feuille", inline: true },
                        ...
                        return interaction.editReply({
                            embeds: [
                                new EmbedBuilder()
                                    ...
                                    .addFields(
                                        { name: "Mi elección", value: "tijeras", inline: true },
                                        { name: "Eleccion del bot", value: "Piedra", inline: true }
                                    )
                            ],
                            components: []
                        ...
                        return interaction.editReply({
                            embeds: [
                                new EmbedBuilder()
                                    ...
                                    .addFields(
                                        { name: "Mi eleccion", value: "Tijeras", inline: true },
                                        { name: "Eleccion del bot", value: "Papel", inline: true }
                                    )
                            ],
                            components: []
