        ...
        switch (game) {
            case "2048": {
                const Game = new TwoZeroFourEight({
                    ...
                    timeoutTime: 60000,
                    buttonStyle: 'PRIMARY',
                    playerOnlyMessage: 'Solo {jugador} puede usar estos botones..'
                });
            ...
            case "fasttype": {
                const Game = new FastType({
                    ...
                    embed: {
                        title: 'Fast Type',
                        color: '#2f3136',
                        description: 'Tienes {time} segundos para escribir la siguiente frase..'
                    },
                    timeoutTime: 60000,
                    sentence: 'Algunas frases geniales para escribir rápido.',
                    winMessage: '¡Ganaste! Terminaste la carrera de mecanografía en {time} segundos con una velocidad de {wpm} palabras por minuto.',
